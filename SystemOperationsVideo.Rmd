...
#. Input #2
: A secondary feed from the video matrix. This can be used when the windows machine is being used for native PowerPoint, OBS, or Mediashout. You can also choose a second of the three projected images.
...
This device enables us to stream our video content live on services like FaceBook Live and can also be used as a source for Skype and to record content.

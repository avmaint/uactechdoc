...
>Best Practice: You can fire a macro from the software using the macro menu or from the ATEM by pressing the macro button follow by the number.
...
The cameras recall their settings for preset 1 when powered on. This includes the video settings documented here. You should not need to adjust these regularly.

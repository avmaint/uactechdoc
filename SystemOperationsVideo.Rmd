...
>As of Fall 2021: The last two presets have not been programmed.
...
* The Web Presenter device (ZVIU-A004), which is is connected to the VideoMac (CDMU-A002) where it can provide video input for Zoom or OBS. 
...
The video mixer output is sent to the input of the "Web Presenter" box. Its output is feed via USB to the videomac (CDMU-A002)  computer. The computer sees that devices as a web cam.

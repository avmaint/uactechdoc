...
```{r fig.height=2}
img <- readJPEG("../../images/sov-ProgramPreview.jpg") 
...
```{r fig.height=2}
img <- readJPEG("../../images/sov-CutAuto.jpg") 
...
```{r fig.height=2}
img <- readJPEG("../../images/sov-Mix.jpg") 
...
```{r fig.height=2}
img <- readJPEG("../../images/sov-PiP.jpg") 
...
```{r fig.height=2}
img <- readJPEG("../../images/sov-Key1Fill.jpg") 
...
* at about 9:30am, press the "Start Streaming" button. It will then change to be the "stop streaming" button.
...
img <- readJPEG("../../images/sov-ResolveTabs.jpg" ) 
...
```{r fig.height=2, fig.width=4}
img <- readJPEG("../../images/sov-DeliverTabs.jpg" ) 
...
img <- readJPEG("../../images/sov-VideoParameters.jpg" ) 
...
img <- readJPEG("../../images/sov-StartRender.jpg" ) 

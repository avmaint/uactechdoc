...
> As June 8th the macros are laid out in the control software with #1 thorugh #10 on the left column of buttons, and #11 through #20 on the right. This doesn't match the macro numbers expected by the macro buttons on the ATEM. At some point the software will be pregrammed to follow a #1 left - #2 right, #3 left - #4 right pattern.

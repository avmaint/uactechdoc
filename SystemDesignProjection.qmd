...
```{r psi, results='asis'}
#| label: tbl-matrix-inputs
#| tbl-cap: Matrix Inputs
...
```{r pso, results='asis'}
#| label: tbl-matrix-outputs
#| tbl-cap: Matrix Outputs
...
```{r}
#| tbl-cap: Projection Topology Inventory
#| label: tbl-proj-det
selected.at <- c(
              "ZVKU-A001", 
              "ZVVU-0001",
...
NetworkInventory |> 
 ...
 filter(Building == "B1") |>
 select(AssetTag, Location, Usage, MAC, IP, URL, Notes) |>
 arrange(AssetTag) |>
	gt() |>
	opt_stylize(style = 3) |>

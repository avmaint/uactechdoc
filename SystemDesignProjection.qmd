...
1,
"TW A",
"This is the left most third of the Propresenter triple wide display from the decklink (sdi4). Usually routed to the East projector.",

2, 
"TW B",
"This is the centre third of the Propresenter triple wide display from the decklink (sdi6). Usually routed to the Centre projector",

3,
"TW C",
"This is the right most third of the Propresenter triple wide display from the decklink (sdi8). Usually routed to the West projector",

4,
"Stage Display",
"Video input for stage display from Propresenter via the decklink (sdi3). Usually routed to the rear projector.",

5,
"Video input from CDWU-0009",
"Source is Windows running Mediashout and Powerpoint. Not usually used.",

6,
"ATEM Program",
"The Program feed from the ATEM. A copy of what is also streamed. Usually routed to the Lobby the TVs downstrairs.",

7, 
"ATEM Auxillary",
"Auxillary feed from the ATEM video recording mixer. Not usually used but could be used to source different video content from the ATEM. For example a static graphic for the centre projector.",

8,
"CDMU-A001 HDMI",
"The Video output from the HDMI output from CDMU-A001 / ProPresenter. This would be used as a video source from the computer when a system display is required.")
...
Here are some common configurations to use and some ideas abuot when to use them.

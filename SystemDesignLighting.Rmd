...
```{r walls}
all.refs <- rbind(stage.refs, room.refs)
...
ggplot() +
  geom_point(data=lox,              aes(x=x, y=y, color=factor(Channel) ), size=9) +
...
> This section needs to be removed once the 2018 upgrades are complete.

...
This document provides key technical documentation design for the lighting systems at UAC.
...
```{r fig-basic-floor }
#| label: tbl-basic-floor
#| tbl-cap: Basic Floor Plan
df <- plan
 g <- ggplot(df) + coord_equal() +
  # geom_path(data=l1, aes(x=x, y=y) ) +
  # geom_path(data=l2, aes(x=x, y=y) ) +
...
```{r  fig-upstagecentre }
#| label: tbl-upstagecentre
#| tbl-cap: Upstage Centre
p1 <- plan |> 

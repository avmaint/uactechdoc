...
> todo: Control of the ADJ Ultrabar 12 devices on the walls presents a challenge.
> These are configured as 12 address devices.
> This DMX footprint is not directly supported by the echo equipment.
...
![Detailed Programming 1](./_work/sdl-detail-program1.png){fig-detailed-program1} ![Detailed Programming 2](./_work/sdl-detail-program2.png){fig-detailed-program2}
...
The commands from these two control points are added together.
Essentially the brightest level from either control dicates the brightness of any light.

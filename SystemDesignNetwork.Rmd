...
>Todo : As of Jan 2019 new HP wireless access points have been added to the network, and this is relfected in the overall topology view. The asset tags are not recorded here.  They are also not recorded in the AV inventory database.
...
subgraph cluster_balcony { 
  ...
  ap23 [label="ap23", tooltip="HP IAP-315"]
  ap24 [label="ap24", tooltip="HP IAP-315"]
...
subgraph cluster_bsmt {
  ...
  ap11 [label="ap1", tooltip="HP IAP-315"]
  ap12 [label="ap1", tooltip="HP IAP-315"]
  ap13 [label="ap1", tooltip="HP IAP-315"]
  ap14 [label="ap1", tooltip="HP IAP-315"]
  ap15 [label="ap1", tooltip="HP IAP-315"]
}

subgraph cluster_office {
  label="Office"

  ap21 [label="ap21", tooltip="HP IAP-315"]
}

subgraph cluster_lobby {
  label="Lobby"

  ap22 [label="ap22", tooltip="HP IAP-315"]
}

...
If a target_device has a connection to a partner A, and A has a connection to B, and B is listed in the partners parameter, then show that as well. Likewise If B is connected to C and C is listed in the partners parameter show that too. Do this for all connected and listed partner systems.

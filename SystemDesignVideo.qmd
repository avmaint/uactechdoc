...
We currently have two video matrix devices. The older one is based on HDBaseT, and the newer one based on SDI. 
...
All inputs to the matrix are SDI. An input can be routed to a one or more outputs at once. 

...
There is a good collection of videos on YouTube from the [Dante Certification program](https://www.audinate.com/learning/training-certification/dante-certification-program) . You can enroll in the program which will give you access to all of the videos. 
...
:::{.callout-important}
TODO - need to discuss interaction between FoH and Livestream mixes
:::

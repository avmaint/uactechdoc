...
```{r input.list}
#| label: fig-sda-inputs-dlive 
#| fig-cap: "dLive Socket Inputs"
get_inputs("dLive","") |>
	arrange(Interface, Socket) |>
...
```{r top1}
print_inv(c( "2407-3000", "2407-3001", "2407-3002",
			 "CUMU-G002", "ZAPU-0001",
...
```{r eval=FALSE}
#| label: fig-dante-inputs-by-device
#| fig-cap: Dante Inputs by Device
...
```{r eval=FALSE}
#| label: fig-dante-outputs-by-device
#| fig-cap: Dante Outputs by Device
...
```{r dante_inv}
#| label: fig-dante-inventoru
#| fig-cap: Dante Inventory
#| 

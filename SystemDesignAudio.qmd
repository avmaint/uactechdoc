...
The DM1000 inputs are all located in the FoH mix position. The chart below describes Scene 014 default definitions. See @fig-sda-inputs-dm and @fig-sda-inputs-dm-map

```{dot gv-sda-inputs-dm}
...
The settings for this device are all manual and not "storeable". See @fig-dom_settings.

```{r dom_settings}
#| label: fig-dom_settings
...
"M7CL", 1, "In",  "16",    "Mono",
"M7CL", 2, "In",  "1-12",  "Wireless Handheld",
"M7CL", 2, "In",  "BP06",  "Wireless Beltpack",
...
links %>%
  ...
  opt_stylize(style=3)  |>
	tab_header("Console in/out summary") |>
	tab_footnote("Is this table of value?")

...
```{r sop_pco_playlist7_2, echo=FALSE}
...
A PCO generated playlist remains linked to PCO. Items that were defined in PCO cannot be deleted or repositioned, you can add additional items.
...
Once positioned in the playlist ensure that the correct content and lighting cues are set.
...
tab <- get.glossary() |>
	filter(Topic == "ProPresenter7" | Term == 'Bumper') |>

...
Many files have keywords in the file names that make them easier to search for. For example, you can search by colour, eg "red", or for triplewide content "-tw", or for "cross".
...
![Import](../../images/sop-ppt-import-1.png)
...
> As of April 2019 we have changed our video projection configuration. Previously Propresenter produced a single wide image (1920x1080) and we repeated it three times on the screens; this is called singlewide. **Now** Propresenter produces a triplewide image (5760x10180, 5760 = 3*1920) and the three screens are treated as one continuous canvas. 

The ProPresenter projection output is a triplewide configuration. That is three HD images side by side for a total of 5760x1080 pixels. ProPresenter knows that there are three projection screens. We use cues to control which content is displayed where on that wide canvas. 
...
* Multiscreen: "Song ABC Stretch" or "Song ABC Tile". The choice is influenced by how well it looks on the screen. Try Stretch first.
      + The choice of _stretch_ or _tile_ will depend on how the graphic looks. Tile will repeat the graphic three times. Stretch will make one image stretch across all three. 
      + If you pick ‘stretch’ and it isn’t wide enough, you will need to go into the media properties and change the option to “fill screen”
* Clear Props

The choice of _stretch_ or _tile_ will depend on how the graphic looks. Tile will repeat the graphic three times. Stretch will make one image stretch across all three. If you pick ‘stretch’ and it isn’t wide enough, you will need to go into the media properties and change the option to “fill screen”

### Message 

* Stage Display: "Kevin Front No Clock"

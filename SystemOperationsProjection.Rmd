...
>TODO: add links to renewed vision tutorials on the multiscreen module and props.
...
#, navigate to --- need to decide on locatoin --- ensure that the checkbox is selected to embed media
...
> The connectoin between the two computers is defined on the Preferences->Network panel. The synchronization is communicated by playlist number, item number, and slide number, not by name. This is why we make the day's playlist, top of the list (#1 on both machines).

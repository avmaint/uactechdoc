...
The livestream feed comes from the output of the Dominator (via the Rane Distribution Amplifier) and into the Dante network, and then into the video mixer.
...
zaiue002:ch1 -> videomix:ch1 
zaiue002:ch2 -> videomix:ch2 
...
In the event of a problem with the reaper computer or short staffed and the livestream needs to be mixed by Foh, Change the routing of the M7CL bus 14 to go directly to the avio adapter connected to the video mixer.

...
Tech_Inventory <- read_excel("TechInventory.xlsx", 
                            sheet = "TechInventory", col_types=ct)

NetworkInventory <- read_excel("TechInventory.xlsx", sheet = "Network")
...
kable(top_5 , format.args = list(big.mark = ','), align=c("l","l","l","r","r") ) %>%
  kable_styling("striped", full_width = TRUE) 
```
...
kable(byLocation , format.args = list(big.mark = ','), align=c("l","l","l","r","r") ) %>%
  kable_styling("striped", full_width = TRUE)
...
```{r}
kable(forecast,
             caption="Obsolescence forecast by year and category",
             format.args = list(big.mark = ','),
             align=c("l","r","r","r","r")) %>%
  kable_styling("striped", full_width = TRUE)
```
...
knitr::kable(not_in_service , format.args = list(big.mark = ',') ) %>%
  kable_styling("striped", full_width = TRUE)
```

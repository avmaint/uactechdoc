...
Basic operations of the house lights can be accomplished by using the touchpad are the front of the auditorium (office side doors). One of five scenes can be selected. However, once the main lighting console is turned on, it takes over control of the system and this panel is disabled. See the section below for more details.
...
#Controlling the Ligthing System - OLD

> Needs to be re-written to account for new COLORSOURCE console.
...
>insert picture of the screen. 

The last 6 sliders on the bottom row are programmed to looks that are useful for a simple service. 

> This is what I am thinking will be the set-up, but may change my mind once I get my own hands on the board. The way we did this before, we used each setting as a complete look. I may now change this up to take a lego brick approach.

```{r defs}

simple <- tribble(
  ~PlaybackNo, ~Title, ~Description,
  
35, "Base Look", "This is the base look for the service. Used before and after service. Medium Low, colourful stage glow. Cross lit.",

36, "Pre-worship", "Add this in as we are about to sing. Used as the musicians are getting ready; the moments before the first words. House Low, stage set to basic theme, no face light. Cross lit.",

37, "Worship", "Add this in during musical worship; Used for the main worship set. This adds in face light to the vocal and band area.",

38, "Emcee/Announcement", "May not need this... depends on what I decide to do for house light control. Used for announncments and such. Similar to #2, but face light at front and centre only. Cross lit.",

39, "Video", "May not need this - drop to base look. Used for video playback. Stage very dark; a little accent. House dim. Cross dimmmly lit.", 

40, "Message", "Used for the pastor's message. Up stage is darker. House is brighter. Cross lit."
)
...
The upper row is used for specials and will vary over time. The first six have a designated special purpose for sound triggers.
...
7, "Sconse", "?",
8, "MainHouse", "Pendants upper and lower, under balcony",
9, "StagePots" , "?",
10, "Top Wash", "Vocal Area",
11, "Vocal Face Wide", "Big group",
12, "Vocal Face Narrow", "Small Group",
13, "Apron Colour", "The two points plus back.",
14, "Apron White", "Face light",
15, "UltraHex", "",
16, "Cross", "",
17, "Baptism", "",
18, "Front of Apron", ""

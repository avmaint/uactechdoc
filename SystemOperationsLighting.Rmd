...
* For more sophisticated control, The primary lighting control console  is an ETC ColorSource 40AV console.  It is used for all lighting operations more sophisticated than can be accomplished via the keypad panel.
...
> as of Oct 25, these have not yet been programmed. 

...
> Insert a picture of the four sliders.

The first 6 sliders on the bottom row are programmed to looks that are useful for a simple service. 
...
Some of the playback groups, for example the House, also have a straight white slider. This is a quick way of getting to white for that group. 

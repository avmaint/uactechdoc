...
In the default settings, the lower row of 20 sliders are programmed to looks that are usefull for a normal service. 

>> This is what I am thinking will be the set-up, but may change my mind once I get my own hands on the board.
...
21, "Walk in", "Used before and after service. Medium House, colourful stage glow. Cross lit.",

22, "Pre-worship", "Used as the musicians are getting ready; the moments before the first words. House Low, stage set to basic theme, no face light. Cross lit.",

23, "Worship", "Used for the main worship set. Similar to #2, but with face light. Cross lit.",

24, "Emcee/Announcement", "Used for announncments and such. Similar to #2, but face light at front and centre only. Cross lit.",

25, "Video", "Used for video playback. Stage very dark; a little accent. House dim. Cross dimmmly lit.", 

26, "Message", "Used for the pastor's message. Similar to #2. Up stage is darker. House is brighter. Cross lit."
)

...
#. Turn on the power. 
    * Including the console, the balcony closet, and the sconse lights.
#. Operate each of your basic playbacks to ensure things are working correctly.
    * In particular look at the fixtures on the stage floor. They sometimes get moved, unplugged, or reprogrammed. Make sure everything turns on and is aimed correctly.
#. Review the "Order of Service" and look for any special features that need special lighting. 
    * Examples include, Baptisms, Communion, Solos, Dramas
    * Decide on what your look will be for that program segement
#. Decide on your colour choices for the morning
    * Listen to the songs; are they fast or slow, loud or quiet, what is the mood of the lyrics? What colours would be support the mood?
    * Review your colour choices with the lyric/presentation operator 
    * Consider the colour theme for the series as well. 
...
Every color has some kind of emotion tied to it, and color is just one way that we can express mood with stage lighting. Below are listed the general moods and feelings that tend to go with these basic colors:
...
Amber
: Awakening, Rootsy and Raw

Green
: Rootsy, Organic, Calming, Earthy

Aqua
: Gentle, Simple, Water

Blue
: Water, Night-time, Calm, Sullen

White
: Open, Raw, Unfiltered

These colors generally express the emotions listed.  Of course, this is a very simplified way of sharing moods with you, as there are so many millions of tints that each have their own character and moods.
For example faster songs tend to go best in red, yellow, or other bright colors, and slower songs look great in blues, purples and greens.
...
Whatever your colour choices, it is best if there is agreement bewteen the lighting colours and the colours used in video.
...
> Consider swapping Towers and Sconse.
...
keypad <- tribble(
  ...
  1, "Off", "Off",
  2, "Security", "A subset of lights on medium (sconse plus maybe some of the house lights)",
  ...
  5, "Sconse only", "(Might be redundant with 2)",

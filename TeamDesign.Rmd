...
tid <- "audio"
```
This team manages the audio console and the sound that we hear, both online and on the livestream.
`r positionString2(tid)`
`r team.matrix(tid)`
...
tid <- "stage"
```
The stagecraft team will manage the physical design elements we place on the stage. The purpose is to add visual interest to the stage. These physical elements are often illuminated by the lights and can either be abstract or tied into the theme of the season or series.  

We currently do this on a ad-hoc basis 
...
2.	Recruit and train technical staff.
    +	This is a difficult part of the job. Not everyone who wants to twist knobs is suited to the job. Commitment, punctuality, attention to detail, a willingness to learn from the present staff as well as do independent learning is vital. 
...
7. Manage online service used by the ministry
    + Example, Dropbox, Vimeo, Resi 

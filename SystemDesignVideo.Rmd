...
```{r functions}
dump.inv <- function(items) {

selected <- items %>% 
  data.frame(AssetTag=.)

merge( Tech_Inventory, selected) %>% 
...
dump.inv(c("CDWU-0009","CDMU-A001","CDMU-A002"))
```
...
dump.inv(c("ZVKU-A001","ZVVU-A001", "ZVVU-A002", "ZVVU-A003", "ZVVU-0001"))
```
...
dump.inv(c("ZVIU-A002", "ZVKU-A001", "ZVVU-0003"))
```
...
dump.inv(c("ZVIU-A001", "ZVKU-A001", "ZVPU-0001", "ZVVU-0002"))
```
...
```{r}
dump.inv(c("ZVKU-A004", "ZVKU-A001", "CDMU-A002", "ZVCU-A001",

...
>todo: fix up connections for CDMU-A002: usb inputs - network and hdmi outputs.
>todo: web presnter SDI and HDMI inputs.
>todo: CDMU-A001 outputs need to show usbc-hdmi conversion or comment about it. 
>todo: remove guest, add coulorsource
>todo remove vga monitor 

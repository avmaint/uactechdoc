...
---
Hello. Here are all the links to web pages you might need today.
 [Detailed documentation](./index.html)
...
# https://drive.google.com/drive/folders/1kmV6YsG4aHesFdNcXcpGXX4iNsb4PFbu?usp=sharing

#https://drive.google.com/file/d/1vyj2pXSse0-jhqoo_qh0cWWYyfre2qLf/view
...
```{r} 
NetworkInventory %>% 
  filter(AssetTag %in% c("NSCU-A004", "ZVKU-A002", "ZVCU-A001", "ZVCU-A002", "ZVCU-A003")) %>% 
  select(Usage, URL, Device, AssetTag,  Notes) %>%
  kable() %>%
  column_spec( 1,  bold = TRUE ) %>%
  kable_styling("striped", full_width = TRUE)
